#
#  Be sure to run `pod spec lint Jail.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of Jail in Markdown format.
  ...
  s.author             = { "Work" => "" }
  # Or just: s.author    = "Work"
  # s.authors            = { "Work" => "" }
  # s.social_media_url   = "http://twitter.com/Work"
